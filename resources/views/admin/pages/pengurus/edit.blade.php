    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editLabel">Edit Data Pengurus</h5>
        ...
        <form method="POST" action="" id="form-edit">
            ...
            <div class="modal-body">
              <div class="form-group">
                  <label for="edit_nama_pengurus">Nama Pengurus</label>
                  <input type="text" class="form-control" id="edit_nama_pengurus" name="nama_pengurus" required>
              </div>
              <div class="form-group">
