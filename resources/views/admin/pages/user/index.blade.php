                        ...
                        <table class="table table-striped display nowrap"  id="crudTable" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->roles }}</td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-warning" data-route="{{ route('master-user.update', $item->id) }}" 
                                      
                                            onclick="edituser(this)">Ubah password</button>
                                        <form action="{{ route('master-user.delete', $item->id) }}" method="post" class="ml-1 d-inline" id="form-hapus-{{ $item->id }}">
                                            @csrf
                                            @method('delete')
